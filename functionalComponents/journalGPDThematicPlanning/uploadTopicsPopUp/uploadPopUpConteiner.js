...
const UploadTopicsPopUpConteiner = ({
    ...
    <>
      {popUpValue && (
        <SmallUniversalThemePopUp
          ...
          close={() => {}}
          title=""
          title_2="Завантажити\вивантажити теми в EXCEL"
          title_4=""
          title_5=""
          title_6=""
          ...
          confirmContainerMarginTop="10px"
          confirmBtnYes={() => {
            setPopUpValue(false);
          }}
...
export default memo(UploadTopicsPopUpConteiner);
